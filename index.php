...
<body class="font-inter bg-white">
    ...
    <!-- Navbar -->
    <nav class="bg-white text-grey-500 p-6 sticky top-0 z-10">
        <div class="container mx-auto">
            <div class="flex items-center justify-between">
                <!-- Logo -->
                <div>
                    <span class="text-xl font-bold">974 Freedivers</span>
                </div>
                <!-- Navbar Links -->
    ...
    <!-- Inter Section -->
    <section id="inter" class="bg-cover bg-center h-96 mt-8 w-full flex items-center relative"
    ...
    <section id="training" class="container bg-gray-200 mx-auto p-8 m-4 flex items-center justify-center">
        <img src="images/molchanovs.png" alt="Molchanovs Logo" class="w-1/12 mr-4"> <!-- Move the image to the left -->
        <div class="text-left flex-1">
    ...
    <!-- Wave One Section -->
    <section id="wave-one" class="container mx-auto p-8 flex items-center justify-center hover:bg-gray-200">
        <img src="images/m8.png" alt="Wave One Logo" class="w-1/12 mr-4">
        <div class="text-left flex-1">
    ...
    <!-- Wave Two Section -->
    <section id="wave-two" class="container mx-auto p-8 flex items-center justify-center hover:bg-gray-200">
        <img src="images/m9.png" alt="Wave Two Logo" class="w-1/12 mr-4">
        <div class="text-left flex-1">
